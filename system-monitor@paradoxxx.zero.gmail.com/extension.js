...
//        this.actor.connect('allocate', this._boxAllocate.bind(this));
...
const ElementBase = class SystemMonitor_ElementBase extends TipBox {
    ...
    constructor() {
        ...
        Schema.connect('changed::' + this.elt + '-show-text', this.change_text.bind(this));

        this.menu_visible = Schema.get_boolean(this.elt + '-show-menu');
        Schema.connect('changed::' + this.elt + '-show-menu', this.change_menu.bind(this));
        ...
        Schema.connect('changed::' + this.elt + '-style', this.change_style.bind(this));
...
const Cpu = class SystemMonitor_Cpu extends ElementBase {
    ...
    constructor() {
        ...
        this.color_name = ['user', 'system', 'nice', 'iowait', 'other']
        this.max = 100
        this.cpuid = -1 // cpuid is -1 when all cores are displayed in the same graph
        this.cpuid = cpuid;
...
const Mem = class SystemMonitor_Mem extends ElementBase {
    constructor() {
        ...
        this.color_name = ['program', 'buffer', 'cache']
        this.max = 1
        this.item_name = _('Memory');
...
const Net = class SystemMonitor_Net extends ElementBase {
    ...
    constructor() {
        ...
        this.color_name = ['down', 'downerrors', 'up', 'uperrors', 'collisions']
